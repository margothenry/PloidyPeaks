...
popConfidenceDoublet = function(flowDir, ds, xVariable, saveGraph = TRUE){
  ...
  for(k in 1:length(flowNameDs)){
    ...
    if(flowDataMeans$G2_1 != 0){
      midPoint <- flowData[
        which(
          abs(flowData$x-mean(c(flowDataMeans$G1_1, flowDataMeans$G2_1)))==min(abs(flowData$x-mean(c(flowDataMeans$G1_1, flowDataMeans$G2_1))))
        ),
      ]
      ...
      G1RightFlowData <- flowData[which(flowData$x == flowDataMeans$G1_1)+1:which(flowData$x == midPoint$x),]

      leftPeak1 <- G1LeftFlowData[
        which(
          abs(G1LeftFlowData$y-flowDataMeans$sdG1Count)==min(abs(G1LeftFlowData$y-flowDataMeans$sdG1Count))
        ),
      ]
      ...
      rightPeak1 <- G1RightFlowData[
        which(
          abs(G1RightFlowData$y-flowDataMeans$sdG1Count)==min(abs(G1RightFlowData$y-flowDataMeans$sdG1Count))
        ),
      ]
      ...
      leftPeak2 <- G2LeftFlowData[
        which(
          abs(G2LeftFlowData$y-flowDataMeans$sdG2Count)==min(abs(G2LeftFlowData$y-flowDataMeans$sdG2Count))
        ),
      ]
      ...
      rightPeak2 <- G2RightFlowData[
        which(
          abs(G2RightFlowData$y-flowDataMeans$sdG2Count)==min(abs(G2RightFlowData$y-flowDataMeans$sdG2Count))
        ),
      ]
      ...
      midPointDoublet <- flowData[
        which(
          abs(flowData$x-mean(c(flowDataMeans$`doublet G1+G2`, flowDataMeans$G2_1)))==min(abs(flowData$x-mean(c(flowDataMeans$`doublet G1+G2`, flowDataMeans$G2_1))))
        ),
      ]
      ...
      doubletG1G2LeftFlowData <- flowData[which(flowData$x == midPointDoublet$x):which(flowData$x == flowDataMeans$`doublet G1+G2`)-1,]
      doubletG1G2RightFlowData <- flowData[(which(flowData$x == flowDataMeans$`doublet G1+G2`)+1):nrow(flowData),]

      doubletG1G2Left <- doubletG1G2LeftFlowData[
        which(
          abs(doubletG1G2LeftFlowData$y-flowDataMeans$sdG1G2Count)==min(abs(doubletG1G2LeftFlowData$y-flowDataMeans$sdG1G2Count))
        ),
      ]
      ...
      doubletG1G2Right <- doubletG1G2RightFlowData[
        which(
          abs(doubletG1G2RightFlowData$y-flowDataMeans$sdG1G2Count)==min(abs(doubletG1G2RightFlowData$y-flowDataMeans$sdG1G2Count))
        ),
      ]
      ...
      if(!is.na(flowDataMeans$`doublet G2+G2`)){
        ...
        midPointDoublet2 <- flowData[
          which(
            abs(flowData$x-mean(c(flowDataMeans$`doublet G1+G2`, flowDataMeans$`doublet G2+G2`)))==min(abs(flowData$x-mean(c(flowDataMeans$`doublet G1+G2`, flowDataMeans$`doublet G2+G2`))))
          ),
        ]
        ...
        doubletG1G2LeftFlowData <- flowData[which(flowData$x == midPointDoublet2$x):which(flowData$x == flowDataMeans$`doublet G2+G2`)-1,]
        doubletG2G2RightFlowData <- flowData[(which(flowData$x == flowDataMeans$`doublet G2+G2`)+1):nrow(flowData),]

        doubletG2G2Left <- doubletG1G2LeftFlowData[
          which(
            abs(doubletG1G2LeftFlowData$y-flowDataMeans$sdG2G2Count)==min(abs(doubletG1G2LeftFlowData$y-flowDataMeans$sdG2G2Count))
          ),
        ]
        ...
        doubletG2G2Right <- doubletG2G2RightFlowData[
          which(
            abs(doubletG2G2RightFlowData$y-flowDataMeans$sdG2G2Count)==min(abs(doubletG2G2RightFlowData$y-flowDataMeans$sdG2G2Count))
          ),
        ]
        ...
        flowDataMeans01 <- flowDataMeans %>% dplyr::mutate(
          ...
          g1SD = mean(c(rightPeak1$x - flowDataMeans$G1_1, flowDataMeans$G1_1 - leftPeak1$x)),
          g2SD = mean(c(rightPeak2$x - flowDataMeans$G2_1, flowDataMeans$G2_1 - leftPeak2$x)),
          G1g2SD = mean(c(doubletG1G2Right$x - flowDataMeans$`doublet G1+G2`, flowDataMeans$`doublet G1+G2` - doubletG1G2Left$x)),
          G2g2SD = mean(c(doubletG2G2Right$x - flowDataMeans$`doublet G2+G2`, flowDataMeans$`doublet G2+G2` - doubletG2G2Left$x)),
          numG1 = sum(flowData$y[c(which(flowData$x==leftPeak1$x):which(flowData$x==rightPeak1$x))]),
          numG2 = sum(flowData$y[c(which(flowData$x==leftPeak2$x):which(flowData$x==rightPeak2$x))]),
          numDoublet1 = sum(flowData$y[c(which(flowData$x==doubletG1G2Left$x):which(flowData$x==doubletG1G2Right$x))]),
          numDoublet2 = sum(flowData$y[c(which(flowData$x==doubletG2G2Left$x):which(flowData$x==doubletG2G2Right$x))])
        )
      ...
      midPointDoublet <- flowData[
        which(
          abs(flowData$x-mean(c(flowDataMeans$`doublet G1+G2`, flowDataMeans$G1_1)))==min(abs(flowData$x-mean(c(flowDataMeans$`doublet G1+G2`, flowDataMeans$G1_1))))
        ),
      ]
      ...
      doubletG1G2LeftFlowData <- flowData[which(flowData$x == midPointDoublet$x):which(flowData$x == flowDataMeans$`doublet G1+G2`),]
      doubletG1G2RightFlowData <- flowData[which(flowData$x == flowDataMeans$`doublet G1+G2`):nrow(flowData),]
      ...
      if(!is.na(flowDataMeans$`doublet G2+G2`)){
        ...
        doubletG1G2LeftFlowData <- flowData[which(flowData$x == midPointDoublet2$x):which(flowData$x == flowDataMeans$`doublet G2+G2`),]
        doubletG2G2RightFlowData <- flowData[which(flowData$x == flowDataMeans$`doublet G2+G2`):nrow(flowData),]
